 ...
 *  매니페스트의 `homepage` 가 있으면 그것, 없으면 출처에서 만든다: 목록(repo) → 그 저장소, zip → 그 주소.
 *  폴더에 직접 넣은 것(출처 없음)은 링크가 없다. ★공식 플러그인도 제작자 저장소에 있으므로 갈래가 따로 없다
 *  (사용자 결정 2026-09-10: 앱에 담기는 플러그인은 없다). */
