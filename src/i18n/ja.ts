...
export const ja: Dict = {
  ...
  plugins: {
    ...
    takeOut: "キャンバスに出す",
    onCanvas: "キャンバスにあります",
    onCanvasFolded: "キャンバスに · 折りたたみ",
    summary: "キャンバスに {n} · 折りたたみ {m}",
    panelHint: "+ を押すか、行をキャンバスへドラッグするとフレームができます。",
    noCanvas: "キャンバスなし",
    backToCanvas: "キャンバスへ",
    fold: "折りたたむ",
    unfold: "広げる",
    ...
    folderSource: "フォルダ",
    github: "GitHub",
    footnote: "フォルダに直接置いたプラグインは配布元が「フォルダ」と表示され、更新を受け取りません · 各プラグインは作者が管理します",
    applyNote: "インストール・削除・オン/オフは「再起動」後に反映されます",
    chgOn: "{n} をオン",
    chgOff: "{n} をオフ",
    chgRemoved: "{n} を削除",
    chgInstalled: "{n} をインストール",
    noMatch: "該当するプラグインがありません。",
    hint: "インストール・削除・オン/オフ・フォルダへの直接配置は、アプリを再起動すると反映されます。各プラグインは作者が管理しています。問題があれば、そのプラグインの作者にお知らせください。",
    openDir: "プラグインフォルダを開く",
    broken: "読み込み失敗",
    installedHead: "インストール済みプラグイン",
    availableHead: "プラグイン一覧",
    official: "公式",
    user: "ユーザー",
    on: "オン",
    off: "オフ",
    toggled: "「{n}」を{s}にしました。アプリを再起動すると反映されます。",
    install: "インストール",
    update: "更新",
    installing: "インストール中",
    ...
    remove: "削除",
    history: "バージョン履歴",
    historyNone: "記録された履歴がありません",
    historyLoading: "履歴を取得中…",
  ...
  /** 画像編集 (2026-09-22, `src/editor/`) */
  editor: {
    newDoc: "新規ドキュメント",
    untitledN: "新規ドキュメント {n}",
    closeDoc: "閉じる",
    ...
    opacity: "不透明度",
    color: "色",
    cropApply: "切り抜きを適用 (Enter)",
    cropCancel: "キャンセル (Esc)",
    fit: "画面に合わせる",
    fitShort: "合わせ",
    oneToOne: "原寸",
    outsideBg: "キャンバス外の背景",
    ...
    bgDefault: "既定",
    layers: "レイヤー",
    layersHint: "上が前面です。点で表示を切り替え、ドラッグで並べ替えます。",
    layerN: "レイヤー {n}",
    copyOf: "{name} のコピー",
    addLayer: "新規レイヤー",
    dupLayer: "レイヤーを複製",
    ...
    flipV: "上下反転",
    adjust: "補正",
    adjustHint: "選択中のレイヤーにだけ効きます。「適用」でピクセルに焼き込みます。",
    brightness: "明るさ",
    contrast: "コントラスト",
    saturation: "彩度",
    hue: "色相",
    ...
    anchor: "基準",
    anchorHint: "選んだ側は固定され、反対側が伸び縮みします。広げた部分は空です。",
    imageSize: "画像サイズ…",
    imageSizeTitle: "画像サイズ",
    imageSizeHint: "ドキュメントと全レイヤーを同じ比率で変えます。",
    save: "保存",
    saved: "保存しました: {name}",
    saveFail: "保存できませんでした: {e}",
    needSrc: "元の場所が分からないドキュメントは上書きできません。保存フォルダを指定してください。",
    needDestNew: "新規ドキュメントは保存フォルダの指定が必要です",
    sendAsk: "画像編集に送る",
    sendAskBody: "開いているドキュメントがあります。{n}枚をどこに入れますか?",
    asNew: "新規ドキュメント",
    asLayer: "レイヤーとして追加",
  },
  tools: {
    ...
    runConvert: "{n}枚を変換",
    convertedAll: "{n}枚を変換しました",
    converted: "{n}枚変換 · {f}枚失敗",
    noResult: "サーバーが結果を返しませんでした",
    up: "上へ",
    down: "下へ",
    all: "全選択",
    none: "解除",
  ...
  censor: {
    ...
    tools: "ツール",
    toolHint: "ブラシで塗ると隠れ、消しゴムで消します。検出したボックスも同じように消せます。移動ツールでは拡大した画像をドラッグして動かします。",
    toolPan: "移動",
    keys: "ショートカット",
    k_tool: "ツール切替",
    k_size: "ブラシの大きさ",
  ...
  ai: {
    ...
    history: "過去の会話",
    ctx: "コンテキスト {n} · キャッシュ {p}%",
    ctxTip: "直前のリクエストの入力トークンとキャッシュ命中。{at} トークンを超えると次の送信前に前の会話を要約にまとめます。",
    compact: "会話を圧縮（最後のターンだけ残して前を要約）",
    compactNote: "圧縮: 前のメッセージ {n} 件を要約にまとめました",
    compactFail: "圧縮できませんでした: {e}",
    dropLine: "この行を削除",
    rewindHere: "ここからやり直す (この発言とそれ以降を削除して入力欄に戻す)",
    cutAfter: "この返答より後を削除",
    removedN: "メッセージ{n}件を削除しました",
  ...
  common: {
    ...
    trashedButLeft: "ごみ箱へ移動しましたが、元のフォルダーを空にできませんでした。ファイルを開いているプログラムを閉じてから、もう一度削除してください。",
    removed: "削除しました。",
    restored: "元に戻しました。",
    undo: "元に戻す",
    undone: "元に戻しました: {what}",
  ...
  gallery: {
    ...
    artistIndexing: "走査中 {done}/{total}",
    artistError: "インデックスエラー: {msg}",
    artistRefresh: "インデックス更新 (新規・変更された画像のみ再読込)",
    ...
    artistOf: "選んだ画像の作家",
    artistOfNone: "作家タグなし",
    artistOfUnknown: "まだ索引にありません。索引を更新すると入ります。",
    artistCopyAll: "すべてコピー",
    artistCopyOne: "クリックでコピー",
    all: "gallery",
    countImages: "{n}枚",
    dropToKeep: "ここに置くと保存",
    ...
    meta: "画像情報",
    pickHint: "クリック = 選択 · Ctrl/Shift+クリック = 複数 · ダブルクリック = 拡大",
    selected: "{n}枚選択",
    selectAll: "すべて選択",
    bigView: "拡大表示",
    clear: "選択解除",
