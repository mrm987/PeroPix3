...
export const ja: Dict = {
  ...
  editor: {
    ...
    alignRight: "右揃え",
    textN: "テキスト {n}",
    textNoPaint: "テキストレイヤーには描けません。下のレイヤーと結合すると描けます。",
    undo: "元に戻す (Ctrl+Z)",
    redo: "やり直し (Ctrl+Y)",
    size: "サイズ",
    hardness: "硬さ",
    ...
    flipV: "上下反転",
    adjust: "補正",
    adjustHint: "選択中のレイヤーに効きます。保存や下のレイヤーとの結合でピクセルに反映されます。",
    brightness: "明るさ",
    contrast: "コントラスト",
    saturation: "彩度",
    hue: "色相",
    ...
    fillLayer: "塗りつぶし",
    anchor: "基準点",
    anchorHint: "選んだ側は固定され、反対側が伸び縮みします。",
    imageSize: "画像サイズ…",
    ...
    needDest: "フォルダを選ぶまで保存できません",
    noHome: "元ファイルがないキャンバスなので、保存フォルダのみ選べます",
    sendAsk: "画像編集に送る",
    sendAskBody: "開いているキャンバスがあります。{n}枚をどこに入れますか?",
    asNew: "新規キャンバス",
    asLayer: "レイヤーとして追加",
  },
  tools: {
