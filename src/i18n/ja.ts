...
export const ja: Dict = {
  ...
  settings: {
    ...
    mcpTab: "MCP 連携",
    mcpTitle: "MCP 連携",
    mcpHint: "Claude Code のようなエージェントがこのアプリを直接操作します。お使いのツールに合う方をコピーしてください。",
    mcpCopyCmd: "コマンドをコピー (Claude Code)",
    mcpCopyJson: "JSON をコピー (設定ファイル)",
    mcpNextCmd: "コピーしました。ターミナル (PowerShell) に貼り付けて実行すると登録が終わります。",
    mcpNextJson: "コピーしました。お使いのツールの MCP 設定ファイルを開き、mcpServers の中に貼り付けてください。",
