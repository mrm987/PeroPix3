...
export const en = {
  ...
  editor: {
    ...
    flipV: "Flip vertical",
    adjust: "Adjust",
    adjustHint: "Applies to the selected layer only. Press Apply to bake it into pixels.",
    ...
    anchor: "Anchor",
    anchorHint: "The chosen side stays put; the opposite side grows or shrinks. New area is empty.",
    ...
    needSrc: "A document without a source file cannot overwrite. Choose a save folder.",
    needDestNew: "A new document needs a save folder",
    sendAsk: "Send to image editor",
    sendAskBody: "A document is open. Where should the {n} image(s) go?",
    asNew: "New document",
