...
export const en = {
  ...
  settings: {
    ...
    mcpTab: "MCP",
    mcpTitle: "MCP",
    mcpHint: "Agents like Claude Code can drive this app directly. Copy whichever form your tool takes.",
    mcpCopyCmd: "Copy command (Claude Code)",
    mcpCopyJson: "Copy JSON (config file)",
    mcpNextCmd: "Copied. Paste it into your terminal and run it to finish setup.",
    mcpNextJson: "Copied. Open your tool's MCP config file and paste this inside mcpServers.",
