...
export const en = {
  ...
  settings: {
    ...
    keyGuide: {
      ...
      blockDrag: { k: "Drag the block handle", v: "Reorders blocks" },
      blockRename: { k: "Double-click a block name", v: "Renames it" },
      blockText: { k: "Click between chips", v: "Edits the block as text (clicking a chip puts the caret after that tag)" },
