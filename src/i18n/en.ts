...
export const en = {
  ...
  plugins: {
    ...
    hint: "Installing, removing, or dropping a folder in takes effect after you restart the app. Plugins run with the same access as the app; what they do is their author's responsibility.",
    openDir: "Open plugins folder",
    broken: "Failed to load",
    installedHead: "Installed",
    availableHead: "Available",
    official: "official",
    install: "Install",
    update: "Update",
