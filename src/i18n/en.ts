...
export const en = {
  ...
  plugins: {
    ...
    panel: "Plugins",
    takeOut: "Put on the canvas",
    onCanvas: "On the canvas",
    onCanvasFolded: "On the canvas · folded",
    summary: "{n} on canvas · {m} folded",
    panelHint: "Press + or drag a row onto the canvas to open a frame.",
    noCanvas: "No canvas",
    ...
    folderSource: "Folder",
    github: "GitHub",
    footnote: "Plugins dropped into the folder show \"Folder\" as their source and receive no updates · each plugin is maintained by its author",
    applyNote: "Install, remove and on/off take effect after \"Restart now\"",
    chgOn: "{n} on",
    chgOff: "{n} off",
    chgRemoved: "{n} removed",
    chgInstalled: "{n} installed",
    noMatch: "No plugin matches.",
    ...
    availableHead: "Plugin list",
    official: "Official",
    user: "Community",
    on: "On",
    off: "Off",
    toggled: "\"{n}\" is now {s}. Takes effect after you restart the app.",
    install: "Install",
    update: "Update",
  ...
  imgIn: {
    ...
    sumTitle: "Goes into this generation",
    sumBase: "Base image ({mode})",
    sumGroup: "{label} ×{n}",
    sumItem: "· {name}",
    sumMore: "· and {n} more",
    cached: "Cached",
  ...
  /** Image editor (2026-09-22, `src/editor/`) */
  editor: {
    newDoc: "New canvas",
    ...
    textN: "Text {n}",
    textNoPaint: "Cannot paint on a text layer. Merge it down to paint on it.",
    undo: "Undo (Ctrl+Z)",
    redo: "Redo (Ctrl+Y)",
    size: "Size",
    hardness: "Hardness",
    ...
    fit: "Fit",
    fitShort: "Fit",
    oneToOne: "Actual size",
    outsideBg: "Background outside the canvas",
    bgDark: "Dark",
    bgLight: "Light",
    bgChecker: "Checker",
    ...
    bgDefault: "default",
    layers: "Layers",
    layersHint: "Top is front. Click the dot to show or hide, drag to reorder.",
    layerN: "Layer {n}",
    copyOf: "{name} copy",
    addLayer: "New layer",
    ...
    flipV: "Flip vertical",
    adjust: "Adjust",
    adjustHint: "Applies to the selected layer. Baked into pixels when saving or merging down.",
    ...
    fillLayer: "Fill",
    anchor: "Anchor",
    anchorHint: "The chosen side stays put; the opposite side grows or shrinks.",
    imageSize: "Image size…",
    imageSizeTitle: "Image size",
    imageSizeHint: "Scales the document and every layer by the same ratio.",
    save: "Save",
    saved: "Saved: {name}",
    saveFail: "Could not save: {e}",
    needDest: "Cannot save until a folder is chosen",
    noHome: "This canvas has no source file, so only a save folder can be chosen",
    sendAsk: "Send to image editor",
    sendAskBody: "A canvas is open. Where should the {n} image(s) go?",
    asNew: "New canvas",
    asLayer: "Add as layers",
  },
  tools: {
    exifUnknown: "Unknown",
    exifReplace: "Replace",
  ...
  censor: {
    ...
    tools: "Tools",
    toolHint: "Paint to cover, erase to uncover. Detected boxes can be erased the same way. The move tool drags a zoomed image around.",
    toolPan: "Move",
    keys: "Shortcuts",
    k_tool: "Switch tool",
    k_size: "Brush size",
  ...
  ai: {
    ...
    history: "Past chats",
    ctx: "Context {n} · cache {p}%",
    ctxTip: "Input tokens of the last request and cache hits. Above {at} tokens the earlier conversation is summarized before the next message.",
    compact: "Compact chat (keep the last turn, summarize the rest)",
    compactNote: "Compacted: {n} earlier messages folded into a summary",
    compactFail: "Could not compact: {e}",
    dropLine: "Remove this line",
    rewindHere: "Restart from here (removes this message and everything after it, puts it back in the box)",
    cutAfter: "Remove everything after this reply",
    removedN: "Removed {n} messages",
  ...
  gallery: {
    ...
    artistIndexing: "Scanning {done}/{total}",
    artistError: "Index error: {msg}",
    artistRefresh: "Refresh index (re-reads only new or changed images)",
    artistEmpty: "No artist tags yet. Keep images that carry a prompt and they show up here.",
    ...
    artistOf: "Artists of the selected image",
    artistOfNone: "No artist tag",
    artistOfUnknown: "Not in the index yet. Refresh the index to pull it in.",
    artistCopyAll: "Copy all",
    artistCopyOne: "Click to copy",
    all: "gallery",
    ...
    meta: "Image info",
    pickHint: "Click = select · Ctrl/Shift+click = multiple · Double-click = view large",
    selected: "{n} selected",
