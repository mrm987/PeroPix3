...
export const en = {
  ...
  settings: {
    ...
    mcpTitle: "Drive the app from outside (MCP)",
    mcpCopy: "Copy config",
    mcpCopied: "Copied",
    mcpHint: "Agents like Claude Code can drive this app directly. Paste the copied text into that tool's MCP settings. The app must be running; the key is created once and reused.",
