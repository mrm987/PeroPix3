...
export const ko: Dict = {
  ...
  settings: {
    ...
    mcpTab: "MCP 연동",
    mcpTitle: "MCP 연동",
    mcpHint: "클로드 코드 같은 에이전트가 이 앱을 직접 다룹니다. 쓰시는 도구에 맞는 쪽을 복사하세요.",
    mcpCopyCmd: "명령어 복사 (클로드 코드)",
    mcpCopyJson: "JSON 복사 (설정 파일)",
    mcpNextCmd: "복사했습니다. 터미널(파워셸)에 붙여 넣고 실행하면 등록이 끝납니다.",
    mcpNextJson: "복사했습니다. 쓰시는 도구의 MCP 설정 파일을 열어 mcpServers 안에 붙여 넣으세요.",
