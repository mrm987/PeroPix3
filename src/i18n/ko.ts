...
export const ko: Dict = {
  ...
  plugins: {
    ...
    takeOut: "캔버스에 꺼내기",
    onCanvas: "캔버스에 있음",
    onCanvasFolded: "캔버스에 · 접힘",
    summary: "캔버스에 {n} · 접힘 {m}",
    panelHint: "+ 를 누르거나 줄을 캔버스로 끌어 놓으면 프레임이 생깁니다.",
    noCanvas: "캔버스 없음",
    backToCanvas: "캔버스로",
    fold: "접기",
    unfold: "펴기",
    ...
    folderSource: "폴더",
    github: "GitHub",
    footnote: "폴더에 직접 넣은 플러그인은 출처가 「폴더」 로 보이고 업데이트를 받지 않습니다 · 각 플러그인은 제작자가 관리합니다",
    applyNote: "설치·삭제·켜기/끄기는 「다시 켜기」 뒤에 적용됩니다",
    chgOn: "{n} 켬",
    chgOff: "{n} 끔",
    chgRemoved: "{n} 삭제",
    chgInstalled: "{n} 설치",
    noMatch: "찾는 플러그인이 없습니다.",
    hint: "설치·삭제·켜기/끄기·폴더에 직접 넣기 모두 앱을 다시 켜면 적용됩니다. 각 플러그인은 제작자가 관리합니다. 문제가 생기면 해당 플러그인의 제작자에게 알려 주세요.",
    openDir: "플러그인 폴더 열기",
    broken: "못 읽음",
    installedHead: "설치된 플러그인",
    availableHead: "플러그인 목록",
    official: "공식",
    user: "유저",
    on: "켜짐",
    off: "꺼짐",
    toggled: "「{n}」 을(를) {s} 상태로 바꿨습니다. 앱을 다시 켜면 적용됩니다.",
    install: "설치",
    update: "업데이트",
    installing: "설치 중",
    installedMark: "설치됨",
    ...
    remove: "삭제",
    history: "버전별 내역",
    historyNone: "적어 둔 내역이 없습니다",
    historyLoading: "내역을 받는 중…",
  ...
  /** 이미지 편집 (사용자 지시 2026-09-22, `src/editor/`) */
  editor: {
    newDoc: "새 캔버스",
    untitledN: "새 캔버스 {n}",
    closeDoc: "닫기",
    ...
    alignRight: "오른쪽 정렬",
    textN: "글자 {n}",
    textNoPaint: "글자 레이어에는 그릴 수 없습니다. 아래 레이어와 합치면 그릴 수 있습니다.",
    undo: "되돌리기 (Ctrl+Z)",
    redo: "다시 실행 (Ctrl+Y)",
    size: "크기",
    hardness: "경도",
    ...
    bgDefault: "기본",
    layers: "레이어",
    layersHint: "위가 앞입니다. 점을 눌러 켜고 끄고, 끌어서 차례를 바꿉니다.",
    layerN: "레이어 {n}",
    copyOf: "{name} 사본",
    addLayer: "새 레이어",
    dupLayer: "레이어 복제",
    ...
    flipV: "상하 반전",
    adjust: "보정",
    adjustHint: "고른 레이어에 걸립니다. 저장하거나 아래 레이어와 합칠 때 픽셀에 반영됩니다.",
    brightness: "밝기",
    contrast: "대비",
    saturation: "채도",
    hue: "색조",
    ...
    fillLayer: "채움",
    anchor: "기준점",
    anchorHint: "고른 쪽은 붙어 있고 반대쪽이 늘거나 줄어듭니다.",
    imageSize: "이미지 크기…",
    imageSizeTitle: "이미지 크기",
    imageSizeHint: "문서와 레이어 전부를 같은 비로 바꿉니다.",
    save: "저장",
    saved: "저장했습니다: {name}",
    saveFail: "저장하지 못했습니다: {e}",
    needDest: "폴더를 고르기 전에는 저장할 수 없습니다",
    noHome: "원본 파일이 없는 캔버스라 저장 폴더만 고를 수 있습니다",
    sendAsk: "이미지 편집으로 보내기",
    sendAskBody: "열려 있는 캔버스가 있습니다. {n}장을 어디에 넣을까요?",
    asNew: "새 캔버스",
    asLayer: "레이어로 추가",
  },
  tools: {
  ...
  censor: {
    ...
    tools: "도구",
    toolHint: "붓으로 칠하면 가려지고, 지우개로 지웁니다. 찾은 박스도 똑같이 지울 수 있습니다. 이동 도구로는 확대한 그림을 끌어 옮깁니다.",
    toolPan: "이동",
    keys: "단축키",
    k_tool: "도구 바꾸기",
    k_size: "붓 크기",
  ...
  common: {
    ...
    // ★내용은 휴지통에 담겼는데 **원래 폴더를 못 비운 경우** — 다른 프로그램이 파일을
    //   쥐고 있으면 그럴 수 있다. 조용히 넘어가면 지운 것이 목록에 그대로 남는다.
    trashedButLeft: "휴지통으로 옮겼지만 원래 폴더를 비우지 못했습니다. 파일을 열어 둔 프로그램을 닫고 다시 지워 주세요.",
  ...
  gallery: {
    ...
    artistIndexing: "훑는 중 {done}/{total}",
    artistError: "색인 오류: {msg}",
    artistRefresh: "색인 갱신 (새 그림·바뀐 그림만 다시 읽음)",
