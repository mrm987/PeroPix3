...
export const ko: Dict = {
  ...
  editor: {
    ...
    flipV: "상하 반전",
    adjust: "보정",
    adjustHint: "고른 레이어에만 걸립니다. 「적용」을 눌러야 픽셀에 굽힙니다.",
    brightness: "밝기",
    contrast: "대비",
    saturation: "채도",
    hue: "색조",
    ...
    anchor: "기준",
    anchorHint: "고른 쪽은 붙어 있고 반대쪽이 늘거나 줄어듭니다. 넓힌 자리는 비어 있습니다.",
    imageSize: "이미지 크기…",
    ...
    needSrc: "원본 자리를 모르는 문서는 덮어쓸 수 없습니다. 저장 폴더를 정해 주세요.",
    needDestNew: "새 문서는 저장할 폴더를 골라야 합니다",
    sendAsk: "이미지 편집으로 보내기",
    sendAskBody: "열려 있는 문서가 있습니다. {n}장을 어디에 넣을까요?",
    asNew: "새 문서",
    asLayer: "레이어로 추가",
  },
  tools: {
