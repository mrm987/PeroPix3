...
export const Icon = {
  ...
  /** 그림 한 장 — 생성에 실리는 이미지 입력이 있다 (`ImageInputBadge`).
   *  ★`images`(갤러리 모드)와 **다른 모양**이어야 한다 — 그쪽은 겹친 두 장이고 이쪽은 한 장이다 */
  picture12: s(
    <>
  ...
  // 그림을 끌어 옮기는 도구 — 커서의 십자 화살표(`cursor: move`)와 같은 뜻이다
  move: s(
    <>
